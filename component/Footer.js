...
// Sample data
const trainingData = [
    { input: 'What is visa?' , output: 'A visa is a paper that lets you enter the U.S.'},
    { input: 'How do I get a green card?' , output: 'You can apply if family or work sponsors you, or if you win the lottery.'},
    { input: 'What is asylum?' , output: 'Asylum is help for people who cannot go back to their country because it is not safe.'},
    { input: 'What is USCIS?' , output: 'USCIS is the office that manages immigration papers.'},
    { input: 'Can you help me?' , output: 'Yes! I help with immigration forms and questions.'},
    { input: 'Can I bring my family?' , output: 'Yes, you can apply to bring your spouse, children, or parents.'},
    { input: 'How do I bring my spouse?' , output: 'You need to fill out a form and send papers to show you are married.'},
    { input: 'Can I bring my kids?' , output: 'Yes, you can bring your kids under 21 if you are a U.S. citizen or resident.'},
    { input: 'Can I bring my brother or sister?' , output: 'U.S. citizens can bring brothers and sisters, but it takes time.'},
    { input: 'What if I dont have enough money to sponsor?' , output: 'You can ask someone else to help as a co-sponsor.'},
    { input: 'Can I work in the U.S.?' , output: 'You need a work visa or work permit to work.'},
    { input: 'How do I get a work visa?' , output: 'You need a job offer from a company in the U.S.'},
    { input: 'Can I work on a student visa?' , output: 'Yes, but only part-time or with special permission.'},
    { input: 'What is a work permit?' , output: 'A work permit is a paper that lets you work in the U.S.'},
    { input: 'How long can I work with a visa?' , output: 'It depends on your visa type. Some are 1 year, others longer.'},
    { input: 'How long does it take to get a green card?' , output: 'It depends. Some take 1 year, others take 10 years.'},
    { input: 'What if I lose my green card?' , output: 'You can apply for a new one with Form I-90.'},
    { input: 'Can I travel with a green card?' , output: 'Yes, but dont stay outside the U.S. for too long.'},
    { input: 'How do I renew my green card?' , output: 'You need to fill out Form I-90 before it expires'},
    { input: 'How do I become a U.S. citizen?' , output: 'You need a green card for 3–5 years, then apply for citizenship.'},
    { input: 'Do I need to take a test for citizenship?' , output: 'Yes, you must take an English and history test.'},
    { input: 'What if I fail the citizenship test?' , output: 'You can take the test again one more time'},
    { input: 'Can I be a citizen of two countries?' , output: 'Yes, the U.S. allows it, but check with your home country.'},
    { input: 'How much does it cost to apply for citizenship?' , output: 'It costs $640 plus $85 for fingerprints.'},
    { input: 'Can I travel if my papers are not done?' , output: 'You need a travel document to leave and come back.'},
    { input: 'What is advance parole?' , output: 'Advance parole is permission to travel while waiting for papers.'},
    { input: 'What happens if my visa expires?' , output: 'You cannot stay or work in the U.S. legally.'},
    { input: 'Can I change my visa?' , output: 'Yes, some visas can be changed, like student to work visa.'},
    { input: 'What is out of status?' , output: 'Out of status means your visa is expired or invalid'},
    { input: 'What is TPS?' , output: 'TPS is temporary protection for people from unsafe countries.'},
    { input: 'Can I apply for DACA?' , output: 'DACA is for people brought to the U.S. as children. You must meet the rules.'},
    { input: 'What is an RFE?' , output: 'RFE means USCIS needs more information for your case.'},
    { input: 'What is immigration?' , output: 'Immigration is moving to live in another country.'},
    { input: 'What is a green card lottery?' , output: 'It is a program where some people can win a green card to live in the U.S.'},
    { input: 'Can I stay in the U.S. after my visa ends?' , output: 'No, you must leave or apply for an extension before it ends.'},
    { input: 'Can I bring my baby to the U.S.?' , output: 'Yes, but the baby needs a passport or visa.'},
    { input: 'How do I fill out immigration forms?' , output: 'I can help you fill out the forms correctly.'},
    { input: 'How much money do I need to sponsor family?' , output: 'It depends on how many people are in your household.'},
    { input: 'Can my child sponsor me?' , output: 'Yes, if your child is a U.S. citizen and at least 21 years old.'},
    { input: 'Can my husband file for me if I am in the U.S.?' , output: 'Yes, if he is a U.S. citizen or green card holder.'},
    { input: 'How long does it take to bring my wife?' , output: 'It depends on your status and country, but usually 12–24 months.'},
    { input: 'What if my family is in danger?' , output: 'You can ask for emergency help or humanitarian parole.'},
    { input: 'How do I pay USCIS fees?' , output: 'You can pay online, with a check, or with a credit card.'},
    { input: 'Can I ask for a fee waiver?' , output: 'Yes, if you dont have enough money, you can request a fee waiver.'},
    ...
    { input: "Can I get a job in the U.S. without papers?" , output: "No, you need a visa or work permit."},
    { input: "What is an H-2B visa?" , output: "It is for temporary non-farm workers, like hotel or construction jobs."},
    { input: "How do I get a sponsor for work?" , output: "Apply for jobs with companies that offer visa sponsorship."},
    { input: "Can I start a business in the U.S. without a green card?" , output: "Yes, but you need the right visa or status to work in your business."},
    { input: "What if I lose my job on a work visa?" , output: "You have 60 days to find a new job or leave the U.S."},
    { input: "What is an F-1 visa?" , output: "It is a visa for students to study in the U.S."},
    { input: "Can I bring my family on a student visa?" , output: "Yes, your spouse and kids can get F-2 visas."},
    { input: "How do I pay for school on a student visa?" , output: "You need to show you have enough money for school and living."},
    { input: "Can I stay after finishing school?" , output: "Yes, you can apply for OPT or a work visa if you qualify."},
    { input: "Can I change from student visa to green card?" , output: "Yes, if you marry a U.S. citizen or find a job sponsor."},
    { input: "Can I get a green card through marriage?" , output: "Yes, if your spouse is a U.S. citizen or green card holder"},
    { input: "How much does a green card cost?" , output: "The USCIS fee is about $1,225. Other costs may apply."},
    { input: "Can I apply for a green card if I am here illegally?" , output: "It depends. You may qualify through marriage or certain programs"},
    { input: "How long is a green card good for?" , output: "Most green cards last 10 years. Conditional green cards last 2 years."},
    { input: "What if my green card expires?" , output: "You can still live in the U.S., but you should renew it quickly."},
    { input: "How long do I need a green card before citizenship?" , output: "You need a green card for 5 years, or 3 years if married to a U.S. citizen."},
    { input: "Do I need to speak English to be a citizen?" , output: "Yes, but some older people or disabled people may get an exception."},
    { input: "Can I take the citizenship test in my language?" , output: "Only if you qualify for an exception based on age or disability."},
    { input: "How do I know if I passed the citizenship test?" , output: "USCIS will tell you after your interview."},
    { input: "What happens if I dont pass the test?" , output: "You can try again in a few months."},
    { input: "Can I stay in the U.S. if I am in danger?" , output: "Yes, you can apply for asylum or humanitarian parole."},
    { input: "Can I apply for asylum if I have been here 2 years?" , output: "Usually, you must apply within 1 year, but there are exceptions."},
    { input: "Can I travel if I have asylum?" , output: "You need a Refugee Travel Document to leave and come back."},
    { input: "What if my visa is expired?" , output: "You may not stay or work legally. Talk to an immigration expert."},
    { input: "Can I fix my status without leaving the U.S.?" , output: "Yes, if you qualify for adjustment of status or certain waivers."},
    { input: "What is a waiver?" , output: "A waiver forgives some immigration problems, like overstaying a visa."},
    { input: "Can I get a green card if I was deported?" , output: "Its possible, but you need a waiver and a strong case."},
    { input: "Can I marry a U.S. citizen to fix my papers?" , output: "Yes, but the marriage must be real. Fake marriages are illegal."},
    { input: "Can I travel while my case is pending?" , output: "Only if you get a travel document or advance parole."},
    { input: "How do I check my case?" , output: "Use your receipt number on the USCIS website."},
    { input: "How long does USCIS take to decide?" , output: "It depends on the case type. Some take months, others years."},
    { input: "Can I apply for immigration myself?" , output: "Yes, but its better to get help to avoid mistakes."},
  ];
